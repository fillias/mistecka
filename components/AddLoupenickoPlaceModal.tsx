...
export default function AddLoupenickoPlaceModal({ loupenickaId }: Props) {
    ...
    const onSubmit: SubmitEventHandler<HTMLFormElement> = async (e) => {
        ...
        try {
            ...
            formData.append('loupenickaId', String(loupenickaId));
            formData.append('gps', gps.trim());
            formData.append('image', imageFile);

            const res = await fetch('/api/add-loupenicko-place', {
                method: 'POST',
                body: formData
